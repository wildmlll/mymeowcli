        ...
        <div className="fixed bottom-0 left-0 right-0 flex justify-around bg-black p-2 safe-area-inset-bottom">
            <button
                ...
                className={`flex-1 py-2 rounded-lg text-center ${
                    currentScreen === 'home' ? 'bg-gradient-violet' : 'bg-gray-700'
            ...
            <button
                ...
                className={`flex-1 py-2 rounded-lg text-center ${
                    currentScreen === 'search' ? 'bg-gradient-violet' : 'bg-gray-700'
                } mx-1 text-sm font-medium`}
            >
                Search
            </button>
            <button
                ...
                className={`flex-1 py-2 rounded-lg text-center ${
                    currentScreen === 'profile' ? 'bg-gradient-violet' : 'bg-gray-700'
                } mx-1 text-sm font-medium`}
            >
                Profile
            </button>
